...
namespace EronNew.Areas.Identity.Pages.Account.Manage
{
    public partial class IndexModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            var firstName = await _userManager.GetFirstName(user);
            if (Input.FirstName != firstName)
            {
                var setFirstName = await _userManager.SetFirstName(user, Input.FirstName);
            ...
            var lastName = await _userManager.GetLastName(user);
            if (Input.LastName != lastName)
            {
                var setLastName = await _userManager.SetLastName(user, Input.LastName);
