        ...
        return _createClass(WYSIWYG, [{
            ...
            value: function bindEvents() {
                $(`#wysiwyg-${this.uuid}`).on("keyup change", this.updateNativeTextarea.bind(this)),
                    ...
                    !0 === this.options.tooltips && $("[data-tooltip]").tooltip({
                        trigger: "hover"
                    })
            }
        }, {
            ...
            value: function renderColorPalette() {
                ...
                $.each(this.options.colorPalette, (function (key, val) {
                    _this.colors += `<li><button data-action="color" data-color="${val}" style="background: ${val};"></button></li>`
                }))
            }
        }, {
            key: "buildTemplate",
...
<div class="mdb-wysiwyg-container" id="wysiwyg-container-${this.uuid}">
    <div class="mdb-wysiwyg-toolbar">
        ...
        <div class="mdb-wysiwyg-toolbar-group">
            <ul class="mdb-wysiwyg-toolbar-options">
                ...
                <li>
                    <button data-tooltip data-placement="bottom" title="${this.options.translations.textcolor}" class="mdb-wysiwyg-toolbar-dropdown-toggle"><i class="fas fa-font"></i></button>
    ...
    <div class="mdb-wysiwyg-textarea" contenteditable="true" id="wysiwyg-${this.uuid}">
        ${this.content}
    </div>
</div>
`;
            ...
            value: function updateToolbar() {
                if (!this.isFocusOnIncorrectTextArea()) {
                    ...
                    $.each(tagnames, (function (key, val) {
                        ...
                        document.queryCommandValue("formatBlock") === tag && $(val).closest(".mdb-wysiwyg-toolbar-dropdown").find("button").text($(val).text())
                    }))
                }
            }
        }, {
            ...
            value: function isFocusOnIncorrectTextArea() {
                ...
                if (selectedElement) {
                    ...
                    selectedTextarea && (selectedTextareaId = selectedTextarea.id)
                }
                return !Boolean(`wysiwyg-${this.uuid}` === selectedTextareaId)
            }
        }, {
            key: "insertLink",
            value: function insertLink(e) {
                if (e.preventDefault(), !this.isFocusOnIncorrectTextArea()) {
                    var url = prompt(this.options.translations.enterurl + ":", "http://"),
                        description = document.getSelection();
                    null === url | "http://" === url || ("" === description.toString() && (description = prompt(this.options.translations.linkdescription + ":", this.options.translations.linkname)), document.execCommand("insertHTML", !1, '<a href="' + url + '" target="_blank">' + description + "</a>"))
                }
            }
        }, {
            key: "insertPicture",
            value: function insertPicture(e) {
                if (e.preventDefault(), !this.isFocusOnIncorrectTextArea()) {
                    ...
                    null === url | "http://" === url || document.execCommand("insertHTML", !1, '<img src="' + url + '" target="_blank" class="img-fluid" />')
                }
            }
        }, {
            key: "performAction",
            value: function performAction(e) {
                ...
                if (e.preventDefault(), !this.isFocusOnIncorrectTextArea()) {
                    ...
                    if (action == "color") {
                        ...
                        document.execCommand("styleWithCSS", !1, !0), document.execCommand("foreColor", !1, color), $(e.target).closest(".mdb-wysiwyg-toolbar-color-palette").removeClass("visible")
                    }
                    else {
                        document.execCommand(action, !1, null)
                    }
                }
            }
        }, {
            ...
            value: function changeTagName(e) {
                if (e.preventDefault(), !this.isFocusOnIncorrectTextArea()) {
                    var $btn = $(e.target);
                    document.execCommand("formatBlock", !1, $btn.data("tagname")),
            ...
            value: function toggleHTML(e) {
                ...
                var $ref = $(e.target).closest('[data-action="toggleHTML"]'),
                    $source = $("#wysiwyg-".concat(this.uuid));
                this.isCodeShown ? ($source.html($source.text()).removeClass("show-raw"), this.isCodeShown = !1, $ref.removeClass("active")) : ($source.text($source.html()).addClass("show-raw"), this.isCodeShown = !0, $ref.addClass("active"))
            }
        }, {
            key: "_randomUUID",
