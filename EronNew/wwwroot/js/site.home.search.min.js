...
<div class="col-sm-12 col-md-3 mb-3">
    <div class="card promoting-card m-2">
        ...
        <div class="card-body d-flex px-2 py-1 form-check-label">
            <span class="p-0 pt-2">
                ${formatMoney(n.PriceTotal,2,",",".")||""}  <b>€</b> - ${formatMoney(n.Square,0,",",".")||""}  <b>m<sup>2</sup></b> - ${n.ConstructionYear||""} <i class="fas fa-home"></i>
            </span>
