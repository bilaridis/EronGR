(function(){function n(n){return`
          <div id="note_${n.Id}" class="d-flex justify-content-start bg-light rounded-3 shadow-1 w-100">
            <p class="p-3 col-11">
