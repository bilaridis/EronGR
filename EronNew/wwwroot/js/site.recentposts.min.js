...
</div> `}const n="/RecentPosts/Query";$(function(){$(".button-collapse").sideNav({breakpoint:1200});$("#loader").css("display","none");$("#sort").change(i=>{i.stopImmediatePropagation(),$("#products").empty(),$("#numberOfPage").val("1"),t(n)});$(".filter-option").change(()=>{$("#products").empty(),t(n)});t(n)});var i=document.querySelector("#infinite-list");i.addEventListener("scroll",function(){if(i.scrollTop+i.clientHeight>=i.scrollHeight){let i=parseInt($("#numberOfPage").val())+1;$("#numberOfPage").val(i);t(n);console.log("Bottom - Time to refresh")}})})();